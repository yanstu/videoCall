...
<head>
    ...
    <link rel="stylesheet" href="./css/mobile.css?v=20211203_13"/>
    <link rel="stylesheet" href="./css/room_mobile.css?v=20211203_06"/>
    <script src="js/ApiHelper.js?v=20211203_28"></script>
...
<body >
    <div id="root">
        ...
        <div id="room-root" class="col-div" style="background-color: #303030;height:100%;">
            <!-- header -->
            <div class="row-div card" style="width: 100%; height: 55px; justify-content: space-between; background-color: #303030;position: absolute;z-index: 99997;top:0;">
                <!-- 视频连线 -->
                <div id="header-roomId" style="font-size: 14px; color: white; margin-left: 15px;width:125px;">
                    <img id="mean_btn" style="width: 35px; height: 35px" src="./img/sf_ic_menu.png" alt=""/>
                    <%--<img id="re_btn" style="width: 40px; height: 40px;margin-left:10px;" src="./img/rebtn.png" alt="">--%>
                    <img style="width: 35px; height: 35px;margin-left:10px;" src="./img/camera-fz.png" alt="" onclick="toggleCamera()"/>
                    <img style="width: 35px; height: 35px;margin-left:10px;" src="./img/check-mic.png" alt="" onclick="showDevice()"/>
                </div>
                <!-- 标题 -->
                <div class="row-div" style="height: 100%; width: 50%; justify-content: center;">
                    <div id="hyTitle" style="width: 100%; height: 23px; font-size: 20px; color: white; justify-content: center;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">
                    </div>
                </div>
                <!-- 分享屏幕 退出 按钮 -->
                <div class="row-div" style="height: 100%; width: 60px;margin-right:10px;">
            ...
            <!-- content -->
            <div id="hidebtn" class="row-div" style="height: 100%; width: 100%; background-color: #666666; padding-top: 55px; display: block;">
                <!-- 主视频 -->
                <div id="video-grid2" style="height: 100%; width: 100%; display: grid; grid-template-columns: repeat(5, 1fr); grid-template-rows: repeat(3, 1fr); grid-template-areas: 'm m m a b'
        'm m m c d'
        'e f g h i';">
                ...
                <!-- 小视频 -->
                <div id="video-grid" style="height: 0%; width: 100%; overflow-y: auto;display: grid; grid-template-columns: repeat(4, 1fr); grid-template-rows: repeat(1, 100%); grid-template-areas: 'm m ' ;">
                </div>
            </div>
            <!-- 主讲人关闭视频背景 -->
            ...
            <div id="bottom_mean" >
                <div></div>
                <div style="width: 100%;justify-content: space-around;background-color: rgba(255,255,255,0.2);padding: 10px;border-radius: 5px;">
                    <div class="icondiv">
                        <img id="mic-btn" style="width: 35px; height: 35px" onclick="event.cancelBubble = true"
                            src="./img/trtcmeeting_ic_mic_on.png" alt=""/>
                        <div style="display: block; text-align: center; color: white; margin-top: 5px;font-size:18px;">麦克风</div>
                    </div>
                    <div class="icondiv">
                        <img id="video-btn" style="width: 35px; height: 35px" onclick="event.cancelBubble = true"
                            src="./img/trtcmeeting_ic_camera_on.png" alt=""/>
                        <div style="display: block; text-align: center; color: white; margin-top: 5px;font-size:18px;">摄像头</div>
                    </div>
                    <div class="icondiv">
                        <img id="show-user" style="width: 35px; height: 35px" src="./img/trtcmeeting_ic_member.png" alt=""/>
                        <div style="display: block; text-align: center; color: white; margin-top: 5px;font-size:18px;">参与者</div>
                    </div>
                    <div class="icondiv" id="sqfy_div">
                        <img id="ApplicationSpeech" style="width: 35px; height: 35px" src="./img/sf_apply_ic.png" alt=""/>
                        <div style="display: block;text-align: center;color:white;margin-top:5px;font-size:18px;">申请发言</div>
                    </div>
                    <%--<div class="icondiv" id="sqfylb_div">
                        <img id="ApplicationSpeechList" style="width: 35px; height: 35px" src="./img/sf_apply_ic.png" alt=""/>
                        <div style="display: block;text-align: center;color:white;margin-top:5px;font-size:14px;">发言列表</div>
                    </div>--%>
                    <%--<div class="icondiv">
                        <img id="" style="width: 35px; height: 35px" src="./img/sf_ic_record.png" alt=""/>
                        <div style="display: block;text-align: center;color:white;margin-top:5px;font-size:14px;">录制</div>
                    </div>--%>
                    <div class="icondiv" >
                        <img id="message-btn" style="width: 35px; height: 35px" src="./img/sf_ic_message.png" alt=""/>
                        <div style="display: block;text-align: center;color:white;margin-top:5px;font-size:18px;">消息</div>
                    </div>
                    <%--<div class="icondiv" id="allmic_div">
                        <img id="Allmic_btn" style="width: 35px; height: 35px" src="./img/auodio_all.png" alt=""/>
                        <div style="display: block;text-align: center;color:white;margin-top:5px;font-size:14px;">关闭麦克风</div>
                    </div>--%>
                    <%--<div class="icondiv">
                        <img id="AllowRecording_btn" style="width: 35px; height: 35px" src="./img/sf_ic_record.png" alt=""/>
                        <div style="display: block;text-align: center;color:white;margin-top:5px;font-size:14px;">允许录制</div>
                    </div>--%>
                    <%--<div class="icondiv">
                        <img id="SetMean" style="width: 35px; height: 35px" src="./img/trtcmeeting_ic_more.png" alt=""/>
                        <div style="display: block;text-align: center;color:white;margin-top:5px;font-size:14px;">设置</div>
                    </div>--%>
                </div>
                <div></div>
            </div>
        ...
        <div id="userLB" class="col-div">
            <div class="col-div card" style="width: 100%; height: 100%; background-color: #FAFAFA; color: black;">
                <div style="background-color: #FAFAFA; color: black; height: 45px;font-size:18px;">成员列表</div>
                <div id="member-list" class="col-div" style="width: 99%; justify-content: flex-start; flex: 1; overflow: auto; background-color: white; color: black; font-size: 16px; padding-top: 10px;">
                    <div id="member-me" class="divnum" style="width: 100%; padding-left: 10px; padding-right: 10px;">
                        <div class="row-div member" style="width: 100%; height: 50px; justify-content: space-between">
                            <text class="member-id" style="font-size: 18px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 75%;color:green;"></text>
                            <div class="row-div" style="width: 25%; height: 26px; justify-content: space-between">
                                <div></div>
                                <div>
                    ...
                    <div id="member-me2" class="divnum" style="width: 100%; padding-left: 10px; padding-right: 10px; display: none;">
                        <div class="row-div member" style="width: 100%; height: 50px; justify-content: space-between">
                            <text class="member-id" style="font-size: 18px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 75%;"></text>
                            <div class="row-div" style="width: 25%; height: 26px; justify-content: space-between">
                                <div></div>
                                <div>
                                    <img class="member-video-btn" style="height: 100%" src="./img/camera-on.png" alt=""/>
        ...
        <div id="SZLB" class="col-div">
            <div class="col-div card" style="width: 100%; height: 100%; background-color: #FAFAFA; color: black;justify-content: space-around;">
            </div>
        </div>
        <!--申请发言列表-->
        <div id="SQFYLB" class="col-div">
            <div class="col-div card" style="width: 100%; height: 100%; background-color: #FAFAFA; color: black;">
                <div style="background-color: #FAFAFA;color: black;height: 45px;font-size: 18px;">申请发言列表</div>
        ...
        <div id="message-box" class="col-div">
            <div class="col-div card" style="width: 100%; height: 100%; background-color: #FAFAFA; color: black;">
                <div style="background-color: #FAFAFA; color: black; height: 45px;font-size: 18px;">消息</div>
            ...
            <div id="zcrfs_btn" style="height: 55px; background-color: #FAFAFA; justify-content: space-between; padding: 20px; width: 100%;">
                <div>
                    <input id="inputmess" style="width: 100%; height: 30px; border-radius: 5px; " maxlength="100" />
                </div>
        ...
        <div id="streamReId" class="col-div">
            <div class="col-div card" style="width: 100%; height: 100%; background-color: #FAFAFA; color: black;border-radius: 6px;padding-bottom: 20px;padding-left: 10px;padding-right: 10px;">
                ...
                <div><button style="width: 70px;margin-top: 12px;border-radius: 6px;height: 32px;font-size: 16px;background-color: slategrey;
    color: white;" onclick="StreamReSume()">确认</button></div>
            </div>
        </div>
        <!--当前网络较差-->
    ...
    <script src="./js/jquery-3.2.1.min.js?v=20211123_01"></script>
    <script src="./js/popper.js"></script>
    <script src="./js/bootstrap-material-design.js?v=20211123_01"></script>
    <script>
    ...
    <script src="https://res2.wx.qq.com/open/js/jweixin-1.6.0.js?v=20211123_01"></script>	
    <script src="./js/lib-generate-test-usersig.min.js?v=20211123_02"></script>
    <script src="./js/debug/GenerateTestUserSig.js"></script>
    <script src="./js/trtc.js?v=20220117_01"></script>
    <script src="./js/common-mobile.js?v=20211207_13"></script>
    <script src="./js/rtc-client-mobile.js?v=20211207_24"></script>
    <script src="./js/share-client.js"></script>
    <script src="./js/presetting.js"></script>
    <script src="./js/rtc-detection.js?v=20211118_56"></script>
    <script src="./js/device-testing.js?v=20211202_08"></script>
    <script src="./js/index.js?v=20211203_05"></script>
    <link rel="stylesheet" href="./lib/layui/css/layui.css" />
    <script src="./lib/layui/layui.js"></script>
    <script src="Scripts/jquery.signalR-2.4.2.min.js?v=20211123_01"></script>
    ...
    <script>
                    ...
                    switch (mess.reCode) {
                        ...
                        case '12':
                            if (mess.ReUserid == '') {
                                ...
                                //第一页视频数
                                userlistlength = UserList.length >= 8 ? 8 : UserList.length;
                                //余数页视频数
                                remainderPage = UserList.length % 8;
                                //视频页数
                                userPage = parseInt(UserList.length / 8) < 1 ? 1 : (remainderPage > 0 ? (parseInt(UserList.length / 8) + 1) : parseInt(UserList.length / 8));
        ...
        function toggleCamera() {
            for (var i = 0; i < cameraData.length; i++) {
                if (cameraId != cameraData[i]) {
                    cameraId = cameraData[i];
                    rtc.ChangeCameraId();
                    return;
                }
            }
