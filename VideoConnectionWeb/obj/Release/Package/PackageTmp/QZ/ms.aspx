<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ms.aspx.cs" Inherits="VideoConnectionWeb.TestItem" %>
  ...
  <body class="w-screen h-screen">
    ...
    <script src="./js/ms/common.js?t=202203260258"></script>
    <script src="./js/ms/rtc-client.js?t=202203260258"></script>
    ...
    <script defer src="./js/ms/chatHub.js?t=202203260258"></script>
