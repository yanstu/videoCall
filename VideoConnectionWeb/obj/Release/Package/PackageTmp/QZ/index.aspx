<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="VideoConnectionWeb.TestItem" %>
  ...
  <body class="w-screen h-screen">
    ...
    <script src="./js/pc/common.js?t=202203261247"></script>
    <script src="./js/pc/rtc-client.js?t=202203261247"></script>
    <script>
    ...
    <script defer src="./js/pc/chatHub.js?t=202203261247"></script>
