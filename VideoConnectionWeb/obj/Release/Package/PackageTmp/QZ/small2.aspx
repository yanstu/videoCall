<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="small2.aspx.cs" Inherits="VideoConnectionWeb.TestItem" %>
  ...
  <body class="w-screen h-screen">
    ...
    <script src="./js/small2/common.js?t=202203251115"></script>
    <script src="./js/small2/rtc-client.js?t=202203251115"></script>
    <script>
    ...
    <script defer src="./js/small2/chatHub.js?t=202203251115"></script>
