<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mobile.aspx.cs" Inherits="VideoConnectionWeb.TestItem" %>
  <!DOCTYPE html>
  <html lang="en">
  ...
  <body class="w-screen h-screen">
    ...
    <script src="./js/mobile/common.js?t=202203260258"></script>
    <script src="./js/rtc-detection.js"></script>
    <script src="./js/mobile/rtc-client.js?t=202203260258"></script>
    ...
    <script defer src="./js/mobile/chatHub.js?t=202203260258"></script>
