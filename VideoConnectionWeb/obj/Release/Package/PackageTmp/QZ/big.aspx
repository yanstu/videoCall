<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="big.aspx.cs" Inherits="VideoConnectionWeb.TestItem" %>
  ...
  <body class="w-screen h-screen">
    ...
    <script src="./js/big/common.js?t=202203261247"></script>
    <script src="./js/big/rtc-client.js?t=202203261247"></script>
    <script>
    ...
    <script defer src="./js/big/chatHub.js?t=202203261247"></script>
